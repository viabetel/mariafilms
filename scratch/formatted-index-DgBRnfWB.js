...
function l() {
  ...
  let T=e=> {
    let n=t-e,r=Math.max(0,Math.min(1,(.08-Math.abs(n))/.05))**1.5,i=n*-30,a=n*(C?80:150);
    return {
      ...
      ref:e,className:`relative h-[600vh] bg-black z-20`,children:(0,o.jsxs)(`div`, {
        className:`sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center`,children:[(0,o.jsx)(s, {
          ...
          className:`absolute inset-0 z-10 flex items-center justify-center pointer-events-none`,style: {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style:T(.08),children:[(0,o.jsx)(`span`, {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style:T(.24),children:[(0,o.jsx)(`span`, {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style:T(.41),children:[(0,o.jsx)(`span`, {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style:T(.58),children:[(0,o.jsx)(`span`, {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style:T(.74),children:[(0,o.jsx)(`span`, {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style:T(.91),children:[(0,o.jsx)(`span`, {
