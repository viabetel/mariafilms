...
function l() {
  return(0,o.jsxs)(`section`, {
    className:`relative bg-black w-full py-16 md:py-24 px-4 md:px-10 flex flex-col gap-8 md:gap-12 z-20`,children:[(0,o.jsxs)(`div`, {
      ...
      className:`flex flex-col md:flex-row md:h-[65vh] gap-3 md:gap-4 w-full`,children:c.map(e=>(0,o.jsxs)(`div`, {
        className:`group flex-1 min-h-[220px] md:min-h-0 h-full overflow-hidden relative rounded-2xl transition-all duration-700 ease-in-out cursor-pointer hover:flex-[2.5] md:hover:flex-[3.5] bg-neutral-900 border border-white/5`,children:[(0,o.jsx)(`img`, {
  ...
  (0,r.useEffect)(()=> {
    let t=()=> {
      if(!e.current)return;
      let t=e.current.getBoundingClientRect(),n=t.height-window.innerHeight;
      t.top>0||t.bottom<window.innerHeight||(s.current&&clearTimeout(s.current),s.current=setTimeout(()=> {
        let e=[.22,.45,.68,.85],r=Math.abs(t.top)/n,i=e[0],a=1/0;
        e.forEach(e=> {
          let t=Math.abs(e-r);
          t<a&&(a=t,i=e)
        }),a>.005&&a<.05&&window.scrollTo( {
          top:window.scrollY+t.top+i*n,behavior:`smooth`
        })
      },400))
    };
    return window.addEventListener(`scroll`,t, {
      ...
      window.removeEventListener(`scroll`,t),s.current&&clearTimeout(s.current)
    }
  },[]);
  let c=t<.12?12:12+((t-.12)/.88)**1.8*138,l=t<.12?1:1+((t-.12)/.88)**1.8*11.5,u=t*480;
  return(0,o.jsx)(`section`, {
    ref:e,className:`relative h-[350vh] bg-black z-25`,children:(0,o.jsxs)(`div`, {
      className:`sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center bg-black`,children:[(0,o.jsx)(`div`, {
        ...
        className:`absolute inset-0 z-20 flex items-center justify-center pointer-events-none`,children:[(0,o.jsxs)(`div`, {
          ...
          style:(()=> {
            ...
            className:`flex flex-col items-center gap-6 w-full`,children:[(0,o.jsxs)(`a`, {
              ...
              className:`flex items-center gap-8 mt-2`,children:[(0,o.jsx)(`a`, {
                href:`https://instagram.com`,target:`_blank`,rel:`noreferrer`,className:`text-neutral-400 hover:text-[#ff007f] transition-colors text-[10px] tracking-widest uppercase font-display-tech font-medium`,children:`instagram`
              }),(0,o.jsx)(`a`, {
                href:`https://vimeo.com`,target:`_blank`,rel:`noreferrer`,className:`text-neutral-400 hover:text-[#ff007f] transition-colors text-[10px] tracking-widest uppercase font-display-tech font-medium`,children:`vimeo`
              }),(0,o.jsx)(`a`, {
                href:`https://youtube.com`,target:`_blank`,rel:`noreferrer`,className:`text-neutral-400 hover:text-[#ff007f] transition-colors text-[10px] tracking-widest uppercase font-display-tech font-medium`,children:`youtube`
              })]
            }),(0,o.jsxs)(`div`, {
        ...
        className:`absolute bottom-10 left-6 md:left-10 flex flex-col gap-1 z-20 font-display-tech text-[10px] text-neutral-500 uppercase tracking-widest transition-opacity duration-300`,style: {
          ...
          children:[`abertura // `,Math.round(c*10)/10,`vw`]
        })]
      })]
    })
  })
  ...
  let e=(0,r.useRef)(null),t=a(e),[n,i]=(0,r.useState)(``),[c,f]=(0,r.useState)(!1),[p,m]=(0,r.useState)(!1),[h,g]=(0,r.useState)(!1),[_,v]=(0,r.useState)(!1),[y,b]=(0,r.useState)(!1),[x,S]=(0,r.useState)(0),[C,w]=(0,r.useState)(!1);
  return(0,r.useEffect)(()=> {
    let e=()=> {
    ...
    children:[!c&&(0,o.jsx)(d, {
      ...
      className:`fixed z-30 px-4 md:px-10 pt-4 md:pt-6 top-0 left-0 right-0 flex items-center justify-between gap-4 pointer-events-none`,children:[(0,o.jsx)(`div`, {
        onMouseEnter:()=>g(!0),onMouseLeave:()=>g(!1),className:`flex items-center justify-center rounded-full transition-all duration-300 pointer-events-auto border $ {
          C?`px-4 py-2 min-h-[48px]`:`px-6 py-3.5 min-h-[72px]`
        }`,style: {
          backgroundColor:`rgba(255, 255, 255, 0.05)`,backdropFilter:`blur(24px)`,WebkitBackdropFilter:`blur(24px)`,borderColor:h?`rgba(255, 0, 127, 0.4)`:`rgba(255, 255, 255, 0.15)`,boxShadow:`0 8px 32px 0 rgba(0, 0, 0, 0.3)`
        },children:n?(0,o.jsx)(`img`, {
          src:n,alt:`maria eduarda logo`,className:`$ {
            C?`h-8`:`h-14`
          } w-auto select-none filter drop-shadow-[0_2px_10px_rgba(255,255,255,0.25)]`
        }):(0,o.jsx)(`span`, {
          className:`text-white text-xs md:text-sm font-normal tracking-tight py-1 px-3`,children:`maria films`
        })
      }),(0,o.jsxs)(`div`, {
        className:`hidden md:flex items-center gap-1 rounded-full px-4 py-3 border pointer-events-auto transition-all duration-300`,style: {
          backgroundColor:`rgba(255, 255, 255, 0.04)`,backdropFilter:`blur(24px)`,WebkitBackdropFilter:`blur(24px)`,borderColor:`rgba(255, 255, 255, 0.12)`,boxShadow:`0 8px 32px 0 rgba(0, 0, 0, 0.3)`
        },children:[(0,o.jsx)(`a`, {
          href:`#films`,className:`text-neutral-300 hover:text-[#ff007f] transition-colors text-base px-6 py-2.5 rounded-full font-medium`,children:`filmes`
        }),(0,o.jsx)(`a`, {
          href:`#about`,className:`text-neutral-300 hover:text-[#ff007f] transition-colors text-base px-6 py-2.5 rounded-full font-medium`,children:`sobre`
        }),(0,o.jsx)(`a`, {
          href:`#services`,className:`text-neutral-300 hover:text-[#ff007f] transition-colors text-base px-6 py-2.5 rounded-full font-medium`,children:`serviços`
        }),(0,o.jsx)(`a`, {
          href:`#contact`,className:`text-neutral-300 hover:text-[#ff007f] transition-colors text-base px-6 py-2.5 rounded-full font-medium`,children:`contato`
        })]
      }),(0,o.jsx)(`button`, {
        onMouseEnter:()=>m(!0),onMouseLeave:()=>m(!1),className:`rounded-full font-medium transition-all duration-300 pointer-events-auto border hover:scale-102 $ {
          C?`px-5 py-2.5 text-xs`:`px-8 py-4 text-base`
        }`,style: {
          backgroundColor:p?`rgba(255, 0, 127, 0.2)`:`rgba(255, 255, 255, 0.06)`,color:`#ffffff`,backdropFilter:`blur(24px)`,WebkitBackdropFilter:`blur(24px)`,borderColor:p?`#ff007f`:`rgba(255, 255, 255, 0.15)`,boxShadow:p?`0 0 25px rgba(255, 0, 127, 0.4)`:`0 8px 32px 0 rgba(0, 0, 0, 0.3)`
        },children:`vamos conversar`
      })]
    }),(0,o.jsx)(`div`, {
      className:`relative w-full h-screen bg-black z-10`,children:x<1&&(0,o.jsxs)(`section`, {
        className:`fixed inset-0 w-full h-screen overflow-hidden bg-black flex items-center pt-24 pb-12`,style: {
          pointerEvents:x>=.85?`none`:`auto`
        },children:[(0,o.jsx)(`div`, {
          className:`absolute inset-y-0 right-0 w-full md:w-[50%] h-full flex items-center justify-center md:justify-end pointer-events-none z-0`,style: {
            opacity:(C?.35:.9-x*1.5)*(1-x),transform:`scale($ {
              1-x*.05
            }) translateY($ {
              x*(C?15:30)
          ...
          className:`relative z-10 container mx-auto px-6 md:px-12 w-full flex flex-col md:flex-row items-center gap-12 min-h-[80vh]`,style: {
            opacity:1-x*2,transform:`translateY(-$ {
              x*(C?40:80)
            }px)`,transition:`opacity 0.05s ease-out, transform 0.05s ease-out`
            ...
            className:`w-full md:w-[60%] flex flex-col gap-8 items-start text-left pointer-events-auto`,children:[(0,o.jsxs)(`div`, {
              ...
              className:`w-full max-w-md border rounded-2xl p-6 md:p-8 transition-all duration-300`,style: {
                ...
                className:`flex flex-col sm:flex-row gap-3.5 w-full`,children:[(0,o.jsxs)(`a`, {
                  href:`#films`,onMouseEnter:()=>v(!0),onMouseLeave:()=>v(!1),className:`flex-1 flex items-center justify-between border rounded-full h-12 pl-5 pr-1.5 transition-all duration-300 text-[10px] uppercase tracking-wider font-semibold font-display-tech relative group overflow-hidden`,style: {
                    backgroundColor:`rgba(255, 255, 255, 0.03)`,borderColor:_?`rgba(255, 0, 127, 0.4)`:`rgba(255, 255, 255, 0.1)`,color:`#ffffff`,boxShadow:_?`0 0 25px rgba(255, 0, 127, 0.25)`:`none`,backdropFilter:`blur(20px)`,WebkitBackdropFilter:`blur(20px)`
                    ...
                    className:`w-8 h-8 rounded-full bg-[#ff007f] flex items-center justify-center transition-all duration-300`,style: {
                      transform:_?`translateX(2px)`:`none`
                  ...
                  href:`#contact`,onMouseEnter:()=>b(!0),onMouseLeave:()=>b(!1),className:`flex-1 flex items-center justify-center border rounded-full h-12 px-5 transition-all duration-300 text-[10px] uppercase tracking-wider font-semibold font-display-tech`,style: {
                    backgroundColor:y?`rgba(255, 255, 255, 0.06)`:`transparent`,borderColor:y?`rgba(255, 255, 255, 0.25)`:`rgba(255, 255, 255, 0.1)`,color:`#ffffff`,backdropFilter:`blur(20px)`,WebkitBackdropFilter:`blur(20px)`
                  },children:(0,o.jsx)(`span`, {
          ...
          className:`absolute bottom-6 left-0 right-0 z-10 w-full px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-6 pointer-events-none`,style: {
            opacity:1-x*2.5,transition:`opacity 0.05s ease-out`
          },children:[(0,o.jsxs)(`div`, {
      ...
      ref:e,className:`relative h-[600vh] bg-black z-20`,children:(0,o.jsxs)(`div`, {
        className:`sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center`,children:[(0,o.jsx)(s, {
          ...
          className:`absolute inset-0 z-10 flex items-center justify-center pointer-events-none`,children:[(0,o.jsxs)(`div`, {
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style: {
              opacity:+(t>=0&&t<.16),transform:`translateY($ {
                (.08-t)*(C?60:150)
              }px)`
            },children:[(0,o.jsx)(`span`, {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style: {
              opacity:+(t>=.16&&t<.33),transform:`translateY($ {
                (.24-t)*(C?60:150)
              }px)`
            },children:[(0,o.jsx)(`span`, {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style: {
              opacity:+(t>=.33&&t<.5),transform:`translateY($ {
                (.41-t)*(C?60:150)
              }px)`
            },children:[(0,o.jsx)(`span`, {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style: {
              opacity:+(t>=.5&&t<.66),transform:`translateY($ {
                (.58-t)*(C?60:150)
              }px)`
            },children:[(0,o.jsx)(`span`, {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style: {
              opacity:+(t>=.66&&t<.83),transform:`translateY($ {
                (.74-t)*(C?60:150)
              }px)`
            },children:[(0,o.jsx)(`span`, {
            ...
            className:`absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6`,style: {
              opacity:+(t>=.83&&t<=1),transform:`translateY($ {
                (.91-t)*(C?60:150)
              }px)`
            },children:[(0,o.jsx)(`span`, {
