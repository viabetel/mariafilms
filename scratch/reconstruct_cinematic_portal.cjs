...
const outPath = 'c:\\Users\\Nicácio\\Documents\\GitHub\\mariafilms\\src\\components\\CinematicPortal.tsx';
...
console.log(`Reconstructed CinematicPortal.tsx written successfully to ${outPath}`);
