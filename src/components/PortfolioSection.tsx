...
const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    title: 'fashion films',
    description: 'exploração estética ousada, coreografia visual e direção de arte impecável para o universo da alta costura.',
    image: '/cinematic_narrative.webp', // reutilizando a imagem de conceito visual
    details: ['marcas: local', 'estilo: editorial em movimento', 'formato: reels/tiktok', 'ano: 2026'],
  },
  {
    id: 'music',
    num: '05 // música',
    category: 'ritmo visual',
    title: 'videoclipes',
    description: 'sincronizando batidas com cortes cinematográficos. direção vibrante focada na performance do artista.',
    image: '/commercial_films.webp', // reutilizando imagem de iluminação dramática
    details: ['artistas: cenário indie', 'direção: maria eduarda', 'formato: clipe musical', 'ano: 2025'],
  },
  {
    id: 'corporate',
    num: '06 // corporativo',
    ...
    description: 'traduzindo valores de grandes empresas em manifestos visuais emocionantes que engajam clientes e equipes.',
    image: '/documentary_stories.webp', // reutilizando imagem de histórias reais
    details: ['formato: manifesto interno', 'foco: narrativa corporativa', 'captação: estúdio', 'status: em andamento'],
  },
];
