export function EditorialSection() {
  return (
    <section id="about" className="relative min-h-screen md:h-screen w-full bg-white text-black overflow-hidden flex items-center py-16 md:py-0 px-6 md:px-16 z-20">
