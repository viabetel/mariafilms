...
export function Features() {
  ...
  useGSAP(
    () => {
      ...
      // MOBILE — sem hover: o reflexo de fundo acende conforme cada card
      // centraliza na tela (eco do efeito de hover do desktop, "dentro do possível").
        ...
        gsap.utils.toArray<HTMLElement>('.feat-card').forEach((card) => {
          ...
          ScrollTrigger.create({
            ...
            onToggle: (self) => {
              if (self.isActive) {
                bg.src = src;
                gsap.to(bg, { autoAlpha: 0.45, scale: 1.2, duration: 0.6, ease: EASE.micro });
              }
            },
          });
        });
