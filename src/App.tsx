...
function App() {
  ...
  // Helper de Motion Cinematográfico para os 6 passos da seção Câmera 360
  const getStepStyle = (center: number) => {
    const diff = progress - center;
    
    // Como temos 6 passos em 1.0 de progresso, a distância entre eles é ~0.16.
    // Para NUNCA sobrepor, a opacidade precisa zerar quando o diff chega em 0.08.
    // Abaixo, garantimos que entre 0.0 e 0.03 o texto fica 100% nítido,
    // e de 0.03 a 0.08 ele some completamente (fade out rápido e seguro).
    const opacityProgress = Math.max(0, Math.min(1, (0.08 - Math.abs(diff)) / 0.05));
    const opacity = Math.pow(opacityProgress, 1.5);
    
    // Reduzi a rotação e a translação para o movimento ser mais contido e elegante,
    // evitando que o texto de baixo "atravesse" o de cima fisicamente.
    ...
    <>
      ...
      <section ref={scrollytellingRef} className="relative h-[600vh] bg-black z-20">
        <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
          ...
          {/* Textos sobrepostos sequenciais (6 Passos) com Perspectiva 3D */}
          <div 
          ...
          >
            ...
            <div
              className="absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6"
              style={getStepStyle(0.24)}
            >
              <span className="text-neutral-500 text-[10px] uppercase tracking-[0.3em] mb-3 block font-display-tech font-semibold">02 // roteiro</span>
              <h2 className="hero-title text-white font-medium text-[8vw] md:text-[6vw] tracking-tight leading-none lowercase">
                desenvolvimento
              </h2>
              <p className="max-w-[440px] text-xs md:text-sm text-white/70 mt-4 leading-relaxed lowercase">
            ...
            <div
              className="absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6"
              style={getStepStyle(0.41)}
            >
              <span className="text-neutral-500 text-[10px] uppercase tracking-[0.3em] mb-3 block font-display-tech font-semibold">03 // produção</span>
              <h2 className="hero-title text-white font-medium text-[8vw] md:text-[6vw] tracking-tight leading-none lowercase">
                direção criativa
              </h2>
              <p className="max-w-[440px] text-xs md:text-sm text-white/70 mt-4 leading-relaxed lowercase">
            ...
            <div
              className="absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6"
              style={getStepStyle(0.58)}
            >
              <span className="text-neutral-500 text-[10px] uppercase tracking-[0.3em] mb-3 block font-display-tech font-semibold">04 // luz</span>
              <h2 className="hero-title text-white font-medium text-[8vw] md:text-[6vw] tracking-tight leading-none lowercase">
                fotografia
              </h2>
              <p className="max-w-[440px] text-xs md:text-sm text-white/70 mt-4 leading-relaxed lowercase">
            ...
            <div
              className="absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6"
              style={getStepStyle(0.74)}
            >
              <span className="text-neutral-500 text-[10px] uppercase tracking-[0.3em] mb-3 block font-display-tech font-semibold">05 // montagem</span>
              <h2 className="hero-title text-white font-medium text-[8vw] md:text-[6vw] tracking-tight leading-none lowercase">
                ritmo e corte
              </h2>
              <p className="max-w-[440px] text-xs md:text-sm text-white/70 mt-4 leading-relaxed lowercase">
            ...
            <div
              className="absolute transition-all duration-300 ease-out flex flex-col items-center text-center px-6"
              style={getStepStyle(0.91)}
            >
              <span className="text-neutral-500 text-[10px] uppercase tracking-[0.3em] mb-3 block font-display-tech font-semibold">06 // execução</span>
              <h2 className="hero-title text-white font-medium text-[8vw] md:text-[6vw] tracking-tight leading-none lowercase">
                pós-produção
              </h2>
              <p className="max-w-[440px] text-xs md:text-sm text-white/70 mt-4 leading-relaxed lowercase">
